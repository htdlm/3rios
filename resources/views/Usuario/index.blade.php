	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-lg-8">
						<h2 class="text-center">Usuarios/Roles</h2>
					</div>
					<div class="col-lg-4">
							...
							<table class="table table-striped table-bordered table-sm" id="tblTabla">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">{{$registro->usuario->email}}</td>
										<td class="text-center">{{$registro->rol->Rol}}</td>
										<td class="text-center">{{$registro->usuario->created_at}}</td>
										<td class="text-center">{{$registro->updated_at}}</td>
										<td class="text-center">
											<button class="btn btn-info btn-bloc btnEditar" value="{{$registro->id}}" data-target="#ventana" data-toggle="modal">Editar</button>
										</td>
										<td class="text-center">
											<a href="{{url('Usuario/eliminar/')}}/{{$registro->id}}">
