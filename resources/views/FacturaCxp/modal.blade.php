@extends('layouts.modal') @section('titulo') Nueva factura @endsection @section('body')
		<form action="/FacturaCxp/agregar" method="post" id="frmAgregar">
			{{csrf_field()}}
			<div class="row">
				<div class="col-lg-6">
					<label for="Numero">Numero de factura <span style="color:#FF0000;font-size: 15pt">*</span></label>
					<input type="text" class="form-control" required placeholder="Numero de la factura" name="FacCxpNum" value="{{old('FacCxpNum')}}" autofocus="autofocus">
