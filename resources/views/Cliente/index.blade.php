						...
						<div class="table-responsive-lg col-lg-12">
							<table class="table table-striped table-bordered table-sm" id="tblTabla">
								...
								<tbody>
									...
									<tr>
										<td class="text-center">{{$cliente->NomCli}}</td>
										<td class="text-center">{{$cliente->EmaCli}}</td>
										<td class="text-center">{{$cliente->DirCli}}</td>
										<td class="text-center">{{$cliente->TelCli}}</td>
										<td class="text-center">{{$cliente->RfcCli}}</td>
										<td class="text-center">
											<button class="btn btn-info btnEditar" value="{{$cliente->CliId}}" data-target="#ventana" data-toggle="modal" >Editar</button>
										</td>
										<td class="text-center">
...
<script src="{{asset('js/cliente/editar.js')}}">
</script>
@endsection